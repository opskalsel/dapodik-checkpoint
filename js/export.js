...
function handleExportExcel() {
  ...
  try {
    ...
    const summaryRows = [
      ...
      ['Metode Update', exportState.metode],
      ...
      stage.items.forEach(function (entry) {
        detailRows.push([
          ...
          entry.item.no === null || entry.item.no === undefined
            ...
            : entry.item.no,
          entry.item.uraian || '',
          formatBulletText(entry.item.halYangHarusDipastikan || ''),
...
function handleExportPDF() {
  ...
  try {
    ...
    doc.setFontSize(13);
    doc.text(
      'LAPORAN PROGRES UPDATE DAPODIK',
      pageWidth / 2,
      y + 6,
      { align: 'center' }
    );
...
/**
 * ============================================================
 * PATCH - FORMAT BULLET "•" MENJADI BARIS TERPISAH (EXPORT)
 * ============================================================
 * Memecah teks berdasarkan simbol "•" sehingga setiap bullet
 * berada di baris sendiri pada hasil export PDF/Excel.
 */
